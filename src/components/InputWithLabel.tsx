...
import { InputProps } from '../components/interfaces/InputProps'; // Importing the updated interface
    ...
    <div>
      ...
      <div className="mt-2 relative">
        <input
          ...
          className={`block ${inputWidth} rounded-md border-0 py-1.5 px-3 ml text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 ${focusBorderColor} sm:text-sm sm:leading-6 font-normal disabled:opacity-70 disabled:cursor-not-allowed`}
        />
        ...
        {type === 'password' && (
          ...
          >
            {showPassword ? (
              <Image src="/eye-on.svg" alt="show-password-icon" width={24} height={24}/>
            ) : (
              <Image src="/eye-off.svg" alt="hide-password-icon" width={24} height={24}/>
            )}
          </span>
        )}
      </div>
