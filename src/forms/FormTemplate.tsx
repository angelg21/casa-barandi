...
import { FormProps } from '../forms/interfaces/FormTemplateProps'; // Importing the FormProps interface
import { InputComponent } from '../components/InputWithLabel'; // Assuming you have the InputComponent already defined
import { ButtonComponent } from '../components/Button'; // Assuming you have the ButtonComponent already defined
...
export const FormTemplate: React.FC<FormProps> = ({
  formTitle,
  inputs,
  buttonText,
  linkQuestion,
        ...
        <div className='max-[420px]:mx-5'>
          <div className="p-6 bg-white bg-opacity-30 rounded-md shadow-lg w-full py-[32px]">
                    ...
                    <div key={input.id} className="mb-5 flex flex-col gap-3">
                        ...
                        {({ field }: { field: FieldInputProps<string> }) => (
                            <InputComponent
                              ...
                              focusBorderColor="focus:ring-blue-500"
            ...
            <GoogleSignInButton callbackUrl='' isDisabled={isPending}/>
              ...
              {linkQuestion} <a href={linkHref} className="font-bold hover:text-blue-500">
                  {linkText}
              </a>
              </p>
          </div>
