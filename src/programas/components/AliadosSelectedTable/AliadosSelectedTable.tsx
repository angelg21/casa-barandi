...
export const AliadosSelectedTable = ({ aliados, onDelete }: AliadosSelectedTableProps) => {
  return (
              ...
              {aliados.map((aliado, index) => (
                <tr key={index}>
                  <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm">
                    <div className="font-medium text-gray-900">{aliado.name}</div>
                  </td>
                  <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm">
                    <div className="font-medium text-gray-900">{aliado.rif}</div>
                  </td>
                  <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm">
                    <div className="font-medium text-gray-900">{aliado.role}</div>
                  </td>
