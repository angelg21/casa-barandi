import { Precaution, PrecautionMetadataValue, PrecautionMetadataEnum } from "../../interfaces/Servicio";

interface PrecautionsTableProps {
    precautions: Precaution[];
    onDelete: (index: number) => void;
    onEdit: (index: number) => void;
}

export const PrecautionsTable = ({ precautions, onDelete, onEdit }: PrecautionsTableProps) => {
                            ...
                            {precautions.map((precaution, index) => (
                                <tr key={index}>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm">
                                        <div className="font-medium text-gray-900">{precaution.name}</div>
                                    </td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm">
                                        <div className="font-medium text-gray-900">{getTypeDisplayName(precaution.type)}</div>
                                    </td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm">
