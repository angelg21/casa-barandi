...
interface PrescriptionsTableProps {
    prescriptions: { prescriptionName: string }[];
    onDelete: (index: number) => void;
    onEdit: (index: number) => void;
}


export const PrescriptionTable = ({ prescriptions, onDelete, onEdit }: PrescriptionsTableProps) => {
    return (
                            ...
                            {prescriptions.map((prescription, index) => (
                                ...
                                <tr key={index}>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm">
                                        <div className="font-medium text-gray-900">{prescription.prescriptionName}</div>
                                    </td>
